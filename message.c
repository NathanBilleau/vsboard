...
do
{
caractere=argv[n][ptr];
//printf("jhgjg");
if (caractere>0) serialPutchar(hd,caractere);
ptr++;
}
while(caractere!=0);
if (n<(argc-1)) serialPutchar(hd,' ');
}

//caractere=0;

//while (caractere==0){
//if (serialDataAvail(hd)>0) caractere=serialGetchar(hd);
//}
